...
QT_MOC_LITERAL(1, 17, 13), // "createNewProj"
QT_MOC_LITERAL(2, 31, 0), // ""
QT_MOC_LITERAL(3, 32, 7), // "pixSize"
QT_MOC_LITERAL(4, 40, 12), // "onUpdateSize"
QT_MOC_LITERAL(5, 53, 21) // "on_buttonBox_accepted"

    },
    "NewProjectDialog\0createNewProj\0\0pixSize\0"
    "onUpdateSize\0on_buttonBox_accepted"
};
...
void NewProjectDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->createNewProj((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 1: _t->onUpdateSize(); break;
        ...
        {
            typedef void (NewProjectDialog::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&NewProjectDialog::createNewProj)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void NewProjectDialog::createNewProj(int _t1)
{
