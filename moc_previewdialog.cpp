...
QT_MOC_LITERAL(5, 53, 10) // "_imageList"
    ...
    "PreviewDialog\0previewSlot\0\0value\0"
    "std::vector<QImage>\0_imageList"
};
...
void PreviewDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->previewSlot((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< const std::vector<QImage>(*)>(_a[2]))); break;
        default: ;
        }
    }
}
